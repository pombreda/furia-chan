...
def upload_find_auth(file_path, project_name, summary, user_name, password, labels=None,
                     config_dir=None, tries=3):
...
def main():
  ...
  parser.add_option('-w', '--password', dest='pwd',
  ...
  status, reason, url = upload_find_auth(file_path, options.project,
                                         options.summary, options.user, options.pwd, labels, options.config_dir)
  if url:
