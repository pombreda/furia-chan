...
public class FAndExpr extends AbstractFrimpIntLongBinopExpr implements AndExpr
{
    /**
	 * 
	 */
	private static final long serialVersionUID = -2651290697109446738L;

	public FAndExpr(Value op1, Value op2) { super(op1, op2); }
    ...
    {
        return new FAndExpr(Frimp.cloneIfNecessary(getOp1()), Frimp.cloneIfNecessary(getOp2()));
    }
    
    public String getQSymbol() {
		
		return FuriaConstructDefinitions.FURIA_fand;
	}
