...
public class FAddExpr extends AbstractFrimpFloatBinopExpr implements AddExpr
{
    /**
	 * 
	 */
	...
	public FAddExpr(Value op1, Value op2) { super(op1, op2); }
    ...
    {
        return new FAddExpr(Frimp.cloneIfNecessary(getOp1()), Frimp.cloneIfNecessary(getOp2()));
    }
	
	public String getQSymbol() {
		
		return FuriaConstructDefinitions.FURIA_fsum;
	}
