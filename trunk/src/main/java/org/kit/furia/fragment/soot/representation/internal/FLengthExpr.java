...
public class FLengthExpr extends AbstractLengthExpr implements Qable
{
    /**
	 * 
	 */
	private static final long serialVersionUID = 4943415960583420414L;
	public FLengthExpr(Value op)
    {
        super(Frimp.v().newObjExprBox(op));
    }
      
    public Object clone()  // NOPMD by amuller on 11/16/06 4:12 PM
    {
        return new FLengthExpr(Frimp.cloneIfNecessary(getOp()));
    }
