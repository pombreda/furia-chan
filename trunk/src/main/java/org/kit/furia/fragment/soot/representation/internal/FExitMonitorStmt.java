...
public class FExitMonitorStmt extends JExitMonitorStmt implements Qable
{
    /**
	 * 
	 */
	private static final long serialVersionUID = -5271719975902415786L;

	public FExitMonitorStmt(Value op)
    {
        super(((Frimp)(Frimp.v())).newExprBox(op));
    }
    
    public Object clone()  // NOPMD by amuller on 11/16/06 4:10 PM
    {
        return new FExitMonitorStmt(Frimp.cloneIfNecessary(getOp()));
    }
