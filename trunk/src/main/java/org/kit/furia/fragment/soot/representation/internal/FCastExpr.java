...
public class FCastExpr extends AbstractCastExpr implements Precedence, Qable
{
    /**
	 * 
	 */
	private static final long serialVersionUID = -7172362809498974745L;
    ...
    public String toQ() throws Exception {
		...
		String res = FuriaConstructDefinitions.FURIA_fcast + "(" + Frimp.toQ(getCastType()) + "," + Frimp.toQ(getOp())+  ")";
