...
public class FNewArrayExpr extends AbstractNewArrayExpr implements Precedence, Qable, SpecialConstructContainer
{
  /**
	 * 
	 */
	private static final long serialVersionUID = 8057813930190852739L;

public FNewArrayExpr(Type type, Value size)
    {
      super(type, Frimp.v().newExprBox(size));
    }
  ...
  public int getPrecedence() { return 850; }
    ...
    {
        return new FNewArrayExpr(getBaseType(), Frimp.cloneIfNecessary(getSize()));
    }
