...
public class FVirtualInvokeExpr extends AbstractVirtualInvokeExpr
    implements Precedence, Qable, SpecialConstructContainer
{
    /**
	 * 
	 */
	private static final long serialVersionUID = -6455352440041113825L;

	public FVirtualInvokeExpr(Value base, SootMethodRef methodRef, List args)
    {
    ...
    public Object clone()  // NOPMD by amuller on 11/16/06 4:22 PM
    {
        ...
        return new  FVirtualInvokeExpr(Frimp.cloneIfNecessary(getBase()), methodRef, 
            clonedArgs);
    }
    ...
    public String toQ() throws Exception {
        ...
        buffer.append(FuriaConstructDefinitions.FURIA_fvirtualInvokeExpr + "(" + Frimp.toQ(methodRef ));
