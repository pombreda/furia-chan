...
public class FShlExpr extends AbstractFrimpIntLongBinopExpr implements ShlExpr
{
    /**
	 * 
	 */
	private static final long serialVersionUID = -8876108617679669264L;

	public FShlExpr(Value op1, Value op2) { super(op1, op2); }
    ...
    {
        return new FShlExpr(Frimp.cloneIfNecessary(getOp1()), Frimp.cloneIfNecessary(getOp2()));
    }
