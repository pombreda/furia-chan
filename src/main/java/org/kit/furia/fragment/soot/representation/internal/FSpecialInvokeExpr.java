...
public class FSpecialInvokeExpr extends AbstractSpecialInvokeExpr
    implements Precedence , Qable, SpecialConstructContainer
{
    /**
	 * 
	 */
	private static final long serialVersionUID = 2990166238108949697L;

	public FSpecialInvokeExpr(Value base, SootMethodRef methodRef, List args)
    {
        super((FExprBox)Frimp.v().newObjExprBox(base), methodRef, 
             (FExprBox[]) new FExprBox[args.size()]);
    ...
    public Object clone()  // NOPMD by amuller on 11/16/06 4:21 PM
    {
        ...
        return new FSpecialInvokeExpr(Frimp.cloneIfNecessary(getBase()), 
