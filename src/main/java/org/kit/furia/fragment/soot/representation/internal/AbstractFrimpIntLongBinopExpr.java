...
abstract public class AbstractFrimpIntLongBinopExpr
    extends AbstractIntLongBinopExpr implements Precedence, Qable
{
    AbstractFrimpIntLongBinopExpr(Value op1, Value op2)
    {
        this(Frimp.v().newArgBox(op1),
             Frimp.v().newArgBox(op2));
    }

    protected AbstractFrimpIntLongBinopExpr(ValueBox op1Box, ValueBox op2Box)
    {
        this.op1Box = op1Box;
        this.op2Box = op2Box;
    }
